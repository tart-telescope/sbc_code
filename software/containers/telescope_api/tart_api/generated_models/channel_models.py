...
#   timestamp: 2026-03-18T06:17:53+00:00
#   version:   0.55.0
...
class ChannelToggleResponse(RootModel[dict[constr(pattern=r"^[0-9]+$"), BinaryFlag]]):
    root: dict[constr(pattern=r"^[0-9]+$"), BinaryFlag]
